...
export const FeatureCard = (props: FeatureCardProps) => {
  return (
    ...
    >
      ...
      >
        <div
          className={`text-xl font-semibold box-border caret-transparent leading-6 text-neutral-900 md:text-2xl md:leading-8 ${props.variant}`}
        >
          {props.title}
        </div>
        <div
          className={`text-neutral-600 box-border caret-transparent ${props.variant}`}
        >
