...
export const QuoteSection = ({ showTerms = true }: QuoteSectionProps) => {
  return (
    <section id="contact" className="relative bg-cover bg-center bg-no-repeat pt-[120px] pb-[60px] md:pt-[150px] md:pb-[100px]" style={{ backgroundImage: `url('/hero/jimhero.jpg')` }}>
      ...
      <div className="relative max-w-[1204px] mx-auto px-5 md:px-8">
        <div className="flex flex-col items-center gap-y-8 md:gap-y-12">
          <div className="text-center">
            ...
            <h2 className="text-[44px] font-bold text-white tracking-[-1.44px] leading-[52px] md:text-7xl md:leading-[80px] font-heading uppercase">
              Request a{" "}
              <span className="text-[44px] leading-[52px] font-heading uppercase md:text-7xl md:leading-[80px]">
                Free Quote
              </span>
            </h2>
            <p className="text-white/90 text-[15px] leading-6 mt-4 max-w-[600px] mx-auto md:text-base">
              Fill out the form below and we'll get back to you with a personalized quote for your exterior cleaning needs—roof, render, driveway, gutters, PVC or windows.
            </p>
          </div>
          <QuoteForm />
